...
const About = () => {
  ...
  <Container maxW={'container.lg'} padding='16' boxShadow={'lg'}>
    ...
    <VStack>
      ...
      <Image boxSize={['40', '48']} src={yourprofile} objectFit='contain'/>
      {/* <Text children='CEO & Co-Founder' opacity={0.7} /> */}
    </VStack>

    <VStack justifyContent={'center'} alignItems={['center', 'flex-start']}>
      <Heading children='Atul Aggarwal' size={['md', 'xl']} />
      <Text textAlign={['center', 'left']} children={`Hi, I am a frontend developer and web designer.
  ...
  <Stack direction={['column','row']} spacing={['4','16']} padding={'8'}>
    ...
    <VStack justifyContent={'center'} alignItems={['center', 'flex-start']}>
      ...
      <Text textAlign={['center', 'left']} children={`Hi, I am a backend developer.
      Our mission is to provide quality content at reasonable price.`} />
    </VStack>
  </Stack>
